...
export type PostCommentsQuery = { __typename?: 'Query', comments: Array<{ __typename?: 'Comment', id: string, comment: string, username: string }> };

export type BlogPostIdsQueryVariables = Exact<{ [key: string]: never; }>;


export type BlogPostIdsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'BlogPost', id: string }> };

export type UserMitIdUndNameFragment = { __typename?: 'User', id: string, name: string };

export type PostListPageQueryVariables = Exact<{ [key: string]: never; }>;


export type PostListPageQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'BlogPost', teaser?: string | null, id: string, date: string, title: string, user: { __typename?: 'User', id: string, name: string } }> };
...
export type PostPageQuery = { __typename?: 'Query', post?: { __typename?: 'BlogPost', id: string, title: string, date: string, body: string, likes: number, formattedDate: string } | null };

export type SimpleBlogQueryVariables = Exact<{ [key: string]: never; }>;


export type SimpleBlogQuery = { __typename?: 'Query', post?: { __typename?: 'BlogPost', id: string, formattedDate: string } | null };

export const UserMitIdUndNameFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"UserMitIdUndName"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"User"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}}]}}]} as unknown as DocumentNode<UserMitIdUndNameFragment, unknown>;
